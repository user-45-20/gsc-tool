...
/**
 ** \file parser.hpp
 ** Define the xsk::gsc::t6::parser class.
 */
...
#define YY_DECL xsk::gsc::t6::parser::symbol_type T6lex(yyscan_t yyscanner, xsk::gsc::location& loc, xsk::gsc::compilation_mode comp_mode)
...
#line 13 "parser.ypp"
namespace xsk { namespace gsc { namespace t6 {
#line 204 "parser.hpp"
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        T6_ASSERT ((token::FILE <= tok && tok <= token::INT_HEX));
#endif
      }
    };
